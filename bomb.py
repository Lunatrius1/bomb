...
class spymer:
	def main(self):
		...
		parser = argparse.ArgumentParser(prog='spymer', description="Р’РѕР·РјРѕР¶РЅРѕ С‡С‚Рѕ-С‚Рѕ СѓР¶Рµ РЅРµ СЂР°Р±РѕС‚Р°РµС‚. РўРѕР»СЊРєРѕ РґР»СЏ Р РѕСЃСЃРёРё!")
		parser.add_argument('phonenum', metavar='phone', help='РўРµР»РµС„РѕРЅРЅС‹Р№ РЅРѕРјРµСЂ Р¶РµСЂС‚РІС‹ (РїСЂРёРјРµСЂ: 79991234455)')
		...
		print(showstatus(wrapsbrace('info', True) + ('РћС‚РїСЂР°РІРєР° SMS РЅР°: +{}').format(_phone)))
		print('РђС‚Р°РєР° Р·Р°РїСѓС‰РµРЅР°. \nР•СЃР»Рё Р’С‹ С…РѕС‚РёС‚Рµ РѕСЃС‚Р°РЅРѕРІРёС‚СЊ - РЅР°Р¶РјРёС‚Рµ Ctrl+Z.')
		i = 1
		iteration = 0
		while i < 10:
